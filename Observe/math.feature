...
@wifi_up
 ...
 When Three Observe sessions are created in the app, each having the same amount of observations. In one of the sessions 50% of all moments are assigned to a hand disinfection And in the second session all moments are assigned to "missed" And in this second session different selections for the gloves button and the No ABHR button are made And in the third session 80% of all moments are assigned to a hand disinfection (and 40% to "missed") And of the available occupations randomly (or semi randomly, but not simple rotation) occupations and sub-occupations are selected
 Then in the browser the Observe evaluation "Total Rate - Overall Compliance" of this three audits shows 30% compliance
